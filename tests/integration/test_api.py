...
class TestCharactersEndpoint:
    ...
    @pytest.mark.asyncio
    async def test_get_characters_with_data(self, client: AsyncClient, db_session, sample_character_data):
    ...
    @pytest.mark.asyncio
    async def test_get_character_by_id(self, client: AsyncClient, db_session, sample_character_data):
