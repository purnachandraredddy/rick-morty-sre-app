...
class RickMortyClient:
    ...
    async def _make_request(self, endpoint: str, params: Optional[Dict] = None) -> Dict:
        ...
        try:
            ...
            data = response.json()
            logger.info("API request successful", url=url, status_code=response.status_code)
            return data
    ...
    async def get_all_filtered_characters(self) -> List[CharacterResponse]:
        ...
        while True:
            try:
                ...
                logger.error("Unexpected error fetching characters", page=page, error=str(e))
                break
        
        logger.info("Finished fetching filtered characters", total_count=len(all_characters))
